...
export default function PropertyLeaseScreen() {
  const { id } = useLocalSearchParams();
  const router = useRouter();
  const { getPropertyById, signLease } = useProperty();
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.leaseCard}>
          ...
          <Text style={styles.leaseSubtitle}>{property.title}</Text>
      ...
      <View style={styles.bottomBar}>
        ...
        <TouchableOpacity
          style={[styles.signBtn, (!agreed || signing) && styles.signBtnDisabled]}
          onPress={handleSign}
