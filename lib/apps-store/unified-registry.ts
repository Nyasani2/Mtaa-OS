...
export const APP_STORE_REGISTRY: AppManifest[] = [
  { id: 'mtaxi', name: 'MTaxi', domain: 'mtaxi', version: '1.0.0', entry_point: '/(os)/mtaxi', icon: '🚕', color: '#F59E0B', system_app: false, installable: true, enabled: true, permissions: ['location','notifications'], routes: ['/ride','/history','/driver'], dependencies: ['wallet'] },
  { id: 'mtruck', name: 'MTruck', domain: 'mtruck', version: '1.0.0', entry_point: '/(os)/mtruck', icon: '🚛', color: '#8B5CF6', system_app: false, installable: true, enabled: true, permissions: ['location','notifications'], routes: ['/loads','/trucks','/history'], dependencies: ['wallet'] },
  { id: 'tribes', name: 'Tribes', domain: 'tribes', version: '1.0.0', entry_point: '/(os)/tribes', icon: '👥', color: '#EC4899', system_app: false, installable: true, enabled: true, permissions: ['contacts','notifications'], routes: ['/feed','/groups','/discover'], dependencies: [] },
  { id: 'shop', name: 'Shop', domain: 'shop', version: '1.0.0', entry_point: '/(os)/shop', icon: '🛒', color: '#3B82F6', system_app: false, installable: true, enabled: true, permissions: ['camera','notifications'], routes: ['/browse','/orders','/store'], dependencies: ['wallet'] },
  { id: 'marketplace', name: 'Marketplace', domain: 'marketplace', version: '1.0.0', entry_point: '/(os)/marketplace', icon: '🏪', color: '#14B8A6', system_app: false, installable: true, enabled: true, permissions: ['camera','notifications'], routes: ['/listings','/orders','/messages'], dependencies: ['wallet'] },
  { id: 'jobs', name: 'Jobs', domain: 'jobs', version: '1.0.0', entry_point: '/(os)/jobs', icon: '💼', color: '#F97316', system_app: false, installable: true, enabled: true, permissions: ['notifications'], routes: ['/feed','/applications','/post'], dependencies: [] },
  { id: 'streets', name: 'Streets', domain: 'streets', version: '1.0.0', entry_point: '/(os)/streets', icon: '📹', color: '#EF4444', system_app: false, installable: true, enabled: true, permissions: ['camera','microphone','notifications'], routes: ['/feed','/live','/profile'], dependencies: [] },
  ...
  { id: 'garage', name: 'Garage OS', domain: 'garage', version: '2.0.0', entry_point: '/(garage)', icon: '🔧', color: '#3B82F6', system_app: false, installable: true, enabled: true, permissions: ['location','camera','notifications','bluetooth'], routes: ['/onboarding','/dashboard','/diagnostics','/appointments','/inventory','/fleet','/customer'], dependencies: ['wallet','health'] },
];
