...
export const APP_STORE_REGISTRY: AppManifest[] = [
  ...
  { id: 'civic', name: 'Civic', domain: 'civic', version: '1.0.0', entry: '/(os)/civic', icon: '🏛️', color: '#1E40AF', system_app: false, installable: true, enabled: true, permissions: ['location','notifications'], routes: ['/services','/projects','/documents'], dependencies: [] },
