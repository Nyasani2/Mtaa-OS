...
// ── REALTIME HOOK ──
export function useHeavyEquipmentRealtime(requesterId?: string) {
  const { loadEquipment, loadBookings } = useHeavyEquipmentStore();
  ...
  }, [requesterId, loadEquipment, loadBookings]);
}
