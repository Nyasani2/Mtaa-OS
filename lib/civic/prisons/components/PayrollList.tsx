...
import { usePrisonPayroll } from '../hooks/usePrisonPayroll';
...
export default function PayrollList({ facilityId, period }: Props) {
  const { payrolls, loading } = usePrisonPayroll(facilityId, period);
