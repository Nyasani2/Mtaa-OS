...
export async function getTruckById(id: string): Promise<Truck | null> {
  const { data, error } = await supabase.from('mtruck_trucks').select('*').eq('id', id).maybeSingle();
...
export async function createTruck(data: Partial<Truck>): Promise<Truck | null> {
  const { data: result, error } = await supabase.from('mtruck_trucks').insert(data).select().maybeSingle();
...
export async function updateTruck(id: string, data: Partial<Truck>): Promise<Truck | null> {
  const { data: result, error } = await supabase.from('mtruck_trucks').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getFreightById(id: string): Promise<Freight | null> {
  const { data, error } = await supabase.from('mtruck_shipments').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
...
export async function createFreight(data: Partial<Freight>): Promise<Freight | null> {
  const { data: result, error } = await supabase.from('mtruck_shipments').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateFreight(id: string, data: Partial<Freight>): Promise<Freight | null> {
  const { data: result, error } = await supabase.from('mtruck_shipments').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getFleetById(id: string): Promise<Fleet | null> {
  const { data, error } = await supabase.from('mtruck_fleet').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
...
export async function createFleet(data: Partial<Fleet>): Promise<Fleet | null> {
  const { data: result, error } = await supabase.from('mtruck_fleet').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateFleet(id: string, data: Partial<Fleet>): Promise<Fleet | null> {
  const { data: result, error } = await supabase.from('mtruck_fleet').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getHaulTypeById(id: string): Promise<HaulType | null> {
  const { data, error } = await supabase.from('mtruck_haul_quotes').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
export async function createHaulType(data: Partial<HaulType>): Promise<HaulType | null> {
  const { data: result, error } = await supabase.from('mtruck_haul_quotes').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateHaulType(id: string, data: Partial<HaulType>): Promise<HaulType | null> {
  const { data: result, error } = await supabase.from('mtruck_haul_quotes').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getFreightRequestById(id: string): Promise<FreightRequest | null> {
  const { data, error } = await supabase.from('mtruck_freight_requests').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
...
export async function createFreightRequest(data: Partial<FreightRequest>): Promise<FreightRequest | null> {
  const { data: result, error } = await supabase.from('mtruck_freight_requests').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateFreightRequest(id: string, data: Partial<FreightRequest>): Promise<FreightRequest | null> {
  const { data: result, error } = await supabase.from('mtruck_freight_requests').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getFreightBidById(id: string): Promise<FreightBid | null> {
  const { data, error } = await supabase.from('mtruck_freight_bids').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
export async function createFreightBid(data: Partial<FreightBid>): Promise<FreightBid | null> {
  const { data: result, error } = await supabase.from('mtruck_freight_bids').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateFreightBid(id: string, data: Partial<FreightBid>): Promise<FreightBid | null> {
  const { data: result, error } = await supabase.from('mtruck_freight_bids').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function recordTruckLocation(data: Partial<TruckLocation>): Promise<TruckLocation | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_locations').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function recordTruckTelemetry(data: Partial<TruckTelemetry>): Promise<TruckTelemetry | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_telemetry').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getTruckInspectionById(id: string): Promise<TruckInspection | null> {
  const { data, error } = await supabase.from('mtruck_truck_inspections').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
...
export async function createTruckInspection(data: Partial<TruckInspection>): Promise<TruckInspection | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_inspections').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateTruckInspection(id: string, data: Partial<TruckInspection>): Promise<TruckInspection | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_inspections').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function createTruckDocument(data: Partial<TruckDocument>): Promise<TruckDocument | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_documents').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateTruckDocument(id: string, data: Partial<TruckDocument>): Promise<TruckDocument | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_documents').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getCustomsClearanceById(id: string): Promise<CustomsClearance | null> {
  const { data, error } = await supabase.from('mtruck_customs_clearance').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
...
export async function createCustomsClearance(data: Partial<CustomsClearance>): Promise<CustomsClearance | null> {
  const { data: result, error } = await supabase.from('mtruck_customs_clearance').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateCustomsClearance(id: string, data: Partial<CustomsClearance>): Promise<CustomsClearance | null> {
  const { data: result, error } = await supabase.from('mtruck_customs_clearance').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getDriverFreightJobById(id: string): Promise<DriverFreightJob | null> {
  const { data, error } = await supabase.from('mtruck_driver_freight_jobs').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
export async function createDriverFreightJob(data: Partial<DriverFreightJob>): Promise<DriverFreightJob | null> {
  const { data: result, error } = await supabase.from('mtruck_driver_freight_jobs').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateDriverFreightJob(id: string, data: Partial<DriverFreightJob>): Promise<DriverFreightJob | null> {
  const { data: result, error } = await supabase.from('mtruck_driver_freight_jobs').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getShipperProfileById(id: string): Promise<ShipperProfile | null> {
  const { data, error } = await supabase.from('mtruck_shipper_profiles').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
export async function getShipperProfileByUserId(userId: string): Promise<ShipperProfile | null> {
  const { data, error } = await supabase.from('mtruck_shipper_profiles').select('*').eq('user_id', userId).maybeSingle();
  if (error) return handleError(error, null); return data;
}
export async function createShipperProfile(data: Partial<ShipperProfile>): Promise<ShipperProfile | null> {
  const { data: result, error } = await supabase.from('mtruck_shipper_profiles').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateShipperProfile(id: string, data: Partial<ShipperProfile>): Promise<ShipperProfile | null> {
  const { data: result, error } = await supabase.from('mtruck_shipper_profiles').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getTruckOwnerProfileById(id: string): Promise<TruckOwnerProfile | null> {
  const { data, error } = await supabase.from('mtruck_truck_owner_profiles').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
export async function getTruckOwnerProfileByUserId(userId: string): Promise<TruckOwnerProfile | null> {
  const { data, error } = await supabase.from('mtruck_truck_owner_profiles').select('*').eq('user_id', userId).maybeSingle();
  if (error) return handleError(error, null); return data;
}
export async function createTruckOwnerProfile(data: Partial<TruckOwnerProfile>): Promise<TruckOwnerProfile | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_owner_profiles').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateTruckOwnerProfile(id: string, data: Partial<TruckOwnerProfile>): Promise<TruckOwnerProfile | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_owner_profiles').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function createFreightTracking(data: Partial<FreightTracking>): Promise<FreightTracking | null> {
  const { data: result, error } = await supabase.from('mtruck_freight_tracking').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getRouteById(id: string): Promise<Route | null> {
  const { data, error } = await supabase.from('mtruck_routes').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
export async function createRoute(data: Partial<Route>): Promise<Route | null> {
  const { data: result, error } = await supabase.from('mtruck_routes').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateRoute(id: string, data: Partial<Route>): Promise<Route | null> {
  const { data: result, error } = await supabase.from('mtruck_routes').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function createRouteStop(data: Partial<RouteStop>): Promise<RouteStop | null> {
  const { data: result, error } = await supabase.from('mtruck_route_stops').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateRouteStop(id: string, data: Partial<RouteStop>): Promise<RouteStop | null> {
  const { data: result, error } = await supabase.from('mtruck_route_stops').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getLoadById(id: string): Promise<Load | null> {
  const { data, error } = await supabase.from('mtruck_loads').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
...
export async function createLoad(data: Partial<Load>): Promise<Load | null> {
  const { data: result, error } = await supabase.from('mtruck_loads').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateLoad(id: string, data: Partial<Load>): Promise<Load | null> {
  const { data: result, error } = await supabase.from('mtruck_loads').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getLoadBookingById(id: string): Promise<LoadBooking | null> {
  const { data, error } = await supabase.from('mtruck_load_bookings').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
export async function createLoadBooking(data: Partial<LoadBooking>): Promise<LoadBooking | null> {
  const { data: result, error } = await supabase.from('mtruck_load_bookings').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateLoadBooking(id: string, data: Partial<LoadBooking>): Promise<LoadBooking | null> {
  const { data: result, error } = await supabase.from('mtruck_load_bookings').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getFreightInvoiceById(id: string): Promise<FreightInvoice | null> {
  const { data, error } = await supabase.from('mtruck_freight_invoices').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
...
export async function createFreightInvoice(data: Partial<FreightInvoice>): Promise<FreightInvoice | null> {
  const { data: result, error } = await supabase.from('mtruck_freight_invoices').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateFreightInvoice(id: string, data: Partial<FreightInvoice>): Promise<FreightInvoice | null> {
  const { data: result, error } = await supabase.from('mtruck_freight_invoices').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getTruckMaintenanceById(id: string): Promise<TruckMaintenance | null> {
  const { data, error } = await supabase.from('mtruck_truck_maintenance').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
...
export async function createTruckMaintenance(data: Partial<TruckMaintenance>): Promise<TruckMaintenance | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_maintenance').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateTruckMaintenance(id: string, data: Partial<TruckMaintenance>): Promise<TruckMaintenance | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_maintenance').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function createMTruckDriverPayment(data: Partial<DriverPayment>): Promise<DriverPayment | null> {
  const { data: result, error } = await supabase.from('mtruck_driver_payments').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function createMTruckDriverEarning(data: Partial<DriverEarning>): Promise<DriverEarning | null> {
  const { data: result, error } = await supabase.from('mtruck_driver_earnings').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function createFreightReview(data: Partial<FreightReview>): Promise<FreightReview | null> {
  const { data: result, error } = await supabase.from('mtruck_freight_reviews').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
...
export async function getTruckAvailabilityById(id: string): Promise<TruckAvailability | null> {
  const { data, error } = await supabase.from('mtruck_truck_availability').select('*').eq('id', id).maybeSingle();
  if (error) return handleError(error, null); return data;
}
export async function createTruckAvailability(data: Partial<TruckAvailability>): Promise<TruckAvailability | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_availability').insert(data).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
export async function updateTruckAvailability(id: string, data: Partial<TruckAvailability>): Promise<TruckAvailability | null> {
  const { data: result, error } = await supabase.from('mtruck_truck_availability').update(data).eq('id', id).select().maybeSingle();
  if (error) return handleError(error, null); return result;
}
