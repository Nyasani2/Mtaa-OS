...
export default function LoginScreen() {
  ...
  const enterDevMode = () => {
    Alert.alert('DEV MODE', 'Developer entry unlocked');
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#0A0A0A', justifyContent: 'center', padding: 24 }}>
      ...
      <TouchableOpacity onPress={handleLogin} style={{ backgroundColor: '#10B981', padding: 18, borderRadius: 12, marginBottom: 10 }}>
        <Text style={{ color: 'white', textAlign: 'center', fontWeight: 'bold' }}>Login</Text>
      </TouchableOpacity>

      <TouchableOpacity onPress={handleSignup} style={{ padding: 14 }}>
        <Text style={{ color: '#60A5FA', textAlign: 'center' }}>Create account</Text>
      </TouchableOpacity>
