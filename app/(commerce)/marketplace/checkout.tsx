      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValueFee}>{totals.platformFee.toLocaleString()}</Text>
          </View>
          <View style={styles.summaryRow}>
            <Text style={styles.summaryLabel}>Shipping</Text>
            <Text style={styles.summaryValue}>{totals.shippingTotal.toLocaleString()}</Text>
          </View>
          <View style={styles.summaryDivider} />
          <View style={styles.summaryRow}>
            <Text style={styles.summaryTotalLabel}>Total</Text>
            <Text style={styles.summaryTotalValue}>{totals.total.toLocaleString()}</Text>
          </View>
        </View>
        ...
        <Text style={styles.termsText}>
          By placing this order, you agree to our Terms of Service and Marketplace Policies.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
