      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity style={styles.card}>
            ...
            <Text style={styles.cardBody}>{item.code} {item.department ? "| " + item.department : ""}</Text>
            <Text style={styles.cardMeta}>{item.credits || 0} credits</Text>
          </TouchableOpacity>
        )}
      />
    </View>
...
const styles = StyleSheet.create({
  ...
  cardBody: { color: "#94a3b8", fontSize: 14, marginBottom: 4 },
