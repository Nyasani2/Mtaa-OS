    ...
    <View style={styles.container}>
      ...
      {!showHistory ? (
        <>
          ...
          <TouchableOpacity style={[styles.centerBtnBase, { bottom: selectedAgent ? 280 : 30 }]} onPress={centerOnUser}>
...
const styles = StyleSheet.create({
  ...
  centerBtnBase: { position: 'absolute', right: 16, width: 48, height: 48, borderRadius: 24, backgroundColor: '#1C1C1E', justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4, elevation: 4 },
