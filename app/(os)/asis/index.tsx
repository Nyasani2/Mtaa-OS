...
const ASIS_TOOLS = [
  { id: 'wallet-check', name: 'Wallet Check', icon: 'wallet', description: 'Check balance', category: 'Wallet' },
  { id: 'send-money', name: 'Send Money', icon: 'paper-plane', description: 'Transfer', category: 'Wallet' },
  { id: 'pulse-post', name: 'Create Post', icon: 'newspaper', description: 'Post to Pulse', category: 'Pulse' },
  { id: 'mtaxi-book', name: 'Book Ride', icon: 'taxi', description: 'Request MTaxi', category: 'Transport' },
  { id: 'health-appointment', name: 'Book Appointment', icon: 'hospital', description: 'Health visit', category: 'Health' },
  { id: 'job-search', name: 'Find Jobs', icon: 'briefcase', description: 'Search jobs', category: 'Jobs' },
  { id: 'marketplace-browse', name: 'Browse Shop', icon: 'shopping-bag', description: 'Marketplace', category: 'Shop' },
  { id: 'tribe-join', name: 'Join Tribe', icon: 'users', description: 'Communities', category: 'Tribes' },
  { id: 'civic-report', name: 'Civic Report', icon: 'landmark', description: 'Government', category: 'Civic' },
  { id: 'education-course', name: 'Find Course', icon: 'graduation-cap', description: 'Education', category: 'Education' },
  { id: 'kernel-audit', name: 'System Audit', icon: 'shield-alt', description: 'Health check', category: 'System' },
  { id: 'code-generator', name: 'Code Gen', icon: 'code', description: 'Generate code', category: 'Dev' },
];
  ...
  const renderMessage = ({ item }: { item: AsisMessage }) => {
    ...
    return (
      <View style={[styles.msgRow, isUser ? styles.userRow : styles.asisRow]}>
        ...
        {isUser && (
          <View style={[styles.avatar, styles.userAvatar]}><Text style={styles.avatarText}>U</Text></View>
        )}
      </View>
    );
  };
