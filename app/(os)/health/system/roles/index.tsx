...
import { healthRoleService, ROLE_DISPLAY_NAMES, ROLE_COLORS, type HealthRole } from '@/lib/health/services';
...
export default function StaffManagementScreen() {
  ...
  const filteredStaff = staff.filter((s) => {
    ...
    const mr = roleFilter==='All Roles'||s.role===roleFilter;
    const msearch = !searchQuery || (s.user_full_name||'').toLowerCase().includes(searchQuery.toLowerCase()) || (s.user_email||'').toLowerCase().includes(searchQuery.toLowerCase()) || (s.facility_name||'').toLowerCase().includes(searchQuery.toLowerCase());
    return ms && mr && msearch;
  });
...
const styles = StyleSheet.create({
  container:{flex:1,backgroundColor:'#f8fafc'},header:{flexDirection:'row',alignItems:'center',paddingHorizontal:16,paddingTop:16,paddingBottom:12,backgroundColor:'#fff',borderBottomWidth:1,borderBottomColor:'#e5e7eb'},backBtn:{padding:4,marginRight:12},headerTitle:{fontSize:20,fontWeight:'700',color:'#1f2937',flex:1},adminBadge:{flexDirection:'row',alignItems:'center',backgroundColor:'#dc2626',paddingHorizontal:10,paddingVertical:4,borderRadius:12,gap:4},adminBadgeText:{color:'#fff',fontSize:11,fontWeight:'700'},scopeBanner:{flexDirection:'row',alignItems:'center',backgroundColor:'#eff6ff',paddingHorizontal:16,paddingVertical:10,gap:8,borderBottomWidth:1,borderBottomColor:'#dbeafe'},scopeText:{color:'#2563eb',fontSize:13,fontWeight:'600'},statsRow:{flexDirection:'row',paddingHorizontal:16,paddingVertical:12,gap:10},statCard:{flex:1,alignItems:'center',paddingVertical:14,borderRadius:12,gap:4},statNumber:{fontSize:22,fontWeight:'800'},statLabel:{fontSize:11,color:'#6b7280',fontWeight:'600'},filterSection:{paddingHorizontal:16,paddingBottom:8},searchBox:{flexDirection:'row',alignItems:'center',backgroundColor:'#fff',borderRadius:10,paddingHorizontal:12,paddingVertical:10,borderWidth:1,borderColor:'#e5e7eb',gap:8,marginBottom:10},searchInput:{flex:1,fontSize:15,color:'#1e293b'},filterRow:{marginBottom:8},filterChip:{paddingHorizontal:14,paddingVertical:6,borderRadius:20,backgroundColor:'#fff',borderWidth:1,borderColor:'#e5e7eb',marginRight:8},filterChipActive:{backgroundColor:'#2563eb',borderColor:'#2563eb'},filterChipText:{fontSize:12,color:'#6b7280',fontWeight:'600'},filterChipTextActive:{color:'#fff'},inviteBtn:{flexDirection:'row',alignItems:'center',justifyContent:'center',backgroundColor:'#2563eb',marginHorizontal:16,paddingVertical:12,borderRadius:10,gap:8,marginBottom:8},inviteBtnText:{color:'#fff',fontSize:15,fontWeight:'700'},list:{flex:1,paddingHorizontal:16},emptyState:{alignItems:'center',marginTop:60,paddingHorizontal:24},emptyTitle:{fontSize:18,fontWeight:'700',color:'#6b7280',marginTop:16},emptySubtitle:{fontSize:14,color:'#9ca3af',marginTop:6,textAlign:'center'},staffCard:{backgroundColor:'#fff',borderRadius:12,padding:14,marginBottom:10,borderWidth:1,borderColor:'#e5e7eb'},staffHeader:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:8},roleBadge:{paddingHorizontal:10,paddingVertical:4,borderRadius:8},roleBadgeText:{fontSize:11,fontWeight:'700'},statusBadge:{paddingHorizontal:8,paddingVertical:3,borderRadius:6},staffName:{fontSize:16,fontWeight:'700',color:'#1f2937'},staffEmail:{fontSize:13,color:'#6b7280',marginTop:2},facilityRow:{flexDirection:'row',alignItems:'center',gap:4,marginTop:6},facilityText:{fontSize:12,color:'#6b7280'},staffMeta:{fontSize:12,color:'#9ca3af',marginTop:4},staffActions:{flexDirection:'row',gap:8,marginTop:10},actionBtn:{flexDirection:'row',alignItems:'center',paddingHorizontal:12,paddingVertical:6,borderRadius:8,gap:6},actionBtnText:{fontSize:12,fontWeight:'600'},modalOverlay:{flex:1,backgroundColor:'rgba(0,0,0,0.5)',justifyContent:'flex-end'},modalContent:{backgroundColor:'#fff',borderTopLeftRadius:20,borderTopRightRadius:20,padding:20,paddingBottom:40},modalHeader:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:16},modalTitle:{fontSize:18,fontWeight:'700',color:'#1f2937'},modalLabel:{fontSize:13,fontWeight:'600',color:'#6b7280',marginBottom:6,marginTop:12},modalInput:{borderWidth:1,borderColor:'#e5e7eb',borderRadius:10,paddingHorizontal:12,paddingVertical:10,fontSize:15,color:'#1f2937'},roleSelector:{marginTop:4},roleChip:{paddingHorizontal:14,paddingVertical:8,borderRadius:20,backgroundColor:'#f3f4f6',marginRight:8},roleChipActive:{backgroundColor:'#2563eb'},roleChipText:{fontSize:12,color:'#6b7280',fontWeight:'600'},roleChipTextActive:{color:'#fff'},modalSubmit:{flexDirection:'row',alignItems:'center',justifyContent:'center',backgroundColor:'#2563eb',paddingVertical:14,borderRadius:12,gap:8,marginTop:20},modalSubmitText:{color:'#fff',fontSize:15,fontWeight:'700'},
});
