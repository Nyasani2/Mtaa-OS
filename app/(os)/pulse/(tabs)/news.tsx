...
export default function NewsScreen() {
  ...
  const categories = ['Local', 'County', 'National', 'Community', 'Business'];

  return (
    <View style={styles.container}>
      <Text style={styles.header}>📰 Pulse News</Text>
      ...
      <Text style={styles.empty}>News feed from verified sources</Text>
    </View>
  );
}
