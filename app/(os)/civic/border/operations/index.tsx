...
const operationsModules = [
  { route: '/(os)/civic/border/operations/immigration', label: 'Immigration', icon: '🛂', desc: 'Passport & visa processing' },
  { route: '/(os)/civic/border/operations/staff', label: 'Staff', icon: '👮', desc: 'Officer management & shifts' },
];
...
export default function OperationsHub() {
  ...
  return (
    <SafeAreaWrapper>
      <ScreenHeader title="Operations" subtitle="Border operations centre" />
