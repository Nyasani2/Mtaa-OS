...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_05_30" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_05_31" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_01" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_02" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_03" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
...
CREATE TABLE IF NOT EXISTS "realtime"."messages_2026_06_04" (
    "topic" "text" NOT NULL,
    "extension" "text" NOT NULL,
    "payload" "jsonb",
    "event" "text",
